...
//后端项目的URL根路径
let baseUrl = "http://47.236.11.35:8092/hospital-api"
app.config.globalProperties.$baseUrl = baseUrl //设置全局变量$baseUrl

//Minio服务器地址
let minioUrl = "http://43.136.28.226:9000/hospital"
app.config.globalProperties.$minioUrl = minioUrl

//使用WebSocket，后端项目给前端页面推送通知
import VueNativeSock from "vue-native-websocket-vue3";
app.use(VueNativeSock, 'ws://47.236.11.35:8092/hospital-api/socket', {
	"format": "json",
});
