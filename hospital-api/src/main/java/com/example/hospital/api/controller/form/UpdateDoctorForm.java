...
public class UpdateDoctorForm {
    ...
    @Pattern(regexp = "^[\\u4e00-\\u9f5a]{2,20}$", message = "name 不正确")
    private String name;

    @NotBlank(message = "pid 不能为空")
    @Pattern(regexp = "^[1-9]\\d{5}(18|19|([23]\\d))\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3}[0-9Xx]$", message = "pid 不正确")
    private String pid;

    @NotBlank(message = "sex 不能为空")
    @Pattern(regexp = "^男$|^女$", message = "sex 不正确")
    private String sex;
    ...
    @NotBlank(message = "degree 不能为空")
    @Pattern(regexp = "^本科$|^研究生$|^博士$", message = "degree is incorrect")
    private String degree;

    @NotBlank(message = "tel 不能为空")
    @Pattern(regexp = "^1[1-9][0-9]{9}$", message = "tel 不正确")
    private String tel;

    @NotBlank(message = "address 不能为空")
    @Length(max = 200, message = "address 不正确")
    ...
    @Pattern(regexp = "^((((1[6-9]|[2-9]\\d)\\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\\d|3[01]))|(((1[6-9]|[2-9]\\d)\\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\\d|30))|(((1[6-9]|[2-9]\\d)\\d{2})-0?2-(0?[1-9]|1\\d|2[0-8]))|(((1[6-9]|[2-9]\\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))$", message = "hiredate 不正确")
    ...
    @Range(min = 1, max = 3, message = "status 不能为空")
    private Byte status;
